...
const (
	// from https://github.com/liangboceo/cfssl_trust/blob/master/ca-bundle.crt
	testCaBundle = "testdata/ca-bundle.pem"
	// from https://github.com/liangboceo/cfssl_trust/blob/master/int-bundle.crt
...
func TestRebundleFromPEM(t *testing.T) {
	t.Skip("expired cert https://github.com/liangboceo/cfssl/issues/1237")
