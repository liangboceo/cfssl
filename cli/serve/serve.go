...
import (
	...
	"github.com/liangboceo/cfssl/api/bundle"
	"github.com/liangboceo/cfssl/api/certadd"
	"github.com/liangboceo/cfssl/api/certinfo"
	"github.com/liangboceo/cfssl/api/crl"
	"github.com/liangboceo/cfssl/api/gencrl"
	"github.com/liangboceo/cfssl/api/generator"
	"github.com/liangboceo/cfssl/api/health"
	"github.com/liangboceo/cfssl/api/info"
	"github.com/liangboceo/cfssl/api/initca"
	apiocsp "github.com/liangboceo/cfssl/api/ocsp"
	"github.com/liangboceo/cfssl/api/revoke"
	"github.com/liangboceo/cfssl/api/scan"
	"github.com/liangboceo/cfssl/api/signhandler"
	...
	ocspsign "github.com/liangboceo/cfssl/cli/ocspsign"
...
// DoMain is the command line entry point to the API server. It sets up a
// new HTTP server to handle sign, bundle, and validate requests.
func DoMain(args []string, c cli.Config) error {
	conf = c
